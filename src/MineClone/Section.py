...
from POGLE.Physics.SpatialTree import QuadTree
...
class Section(PhysicalBox):
    def __init__(self, id: int, aabb: AABB = SECTION_BASE_AABB, block_start: int = 0, chunk: Optional['Chunk'] = None,
        ...
        self.quadtree: QuadTree = QuadTree.XZ(self.bounds)
